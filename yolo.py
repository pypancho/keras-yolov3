...
from yolo3.newmodeltest import yolo_eval, yolo_body, tiny_yolo_body
    ...
    def generate(self):
        ...
        try:
            ...
            self.yolo_model = tiny_yolo_body(Input(shape=(None,None,3)), num_anchors//2, num_classes) \
                if is_tiny_version else yolo_body([Input(shape=(None,None,3)),Input(shape=(None,None,3))], num_anchors//3, num_classes)
    ...
    def detect_image(self, image):
        ...
        out_boxes, out_scores, out_classes = self.sess.run(
            ...
            feed_dict={
                ...
                self.input_image_shape: [image[0].size[1], image[0].size[0]],
                K.learning_phase(): 0
            })
